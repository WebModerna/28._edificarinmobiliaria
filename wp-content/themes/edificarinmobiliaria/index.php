...
<?php $recent = new WP_Query("page_id=202"); while($recent->have_posts()) : $recent->the_post();?>
...
<!-- El loop de WordPress -->
   <div class="clearfix">
	<?php //El Titular de donde estamos. Primero analizaremos si está o no en el home y de acuerdo a eso mostramos un mensaje. 
	if(is_home()==true) { ?>
	...
	<article id="productos_home">
		<ul class="thumbnails">
			...
			if ( have_posts() ) : query_posts($query_string .'&cat=-27'); while ( have_posts() ) : the_post();
			?>
			<li class="span4">
				<div class="thumbnail">
